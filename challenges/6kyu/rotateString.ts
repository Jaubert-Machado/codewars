...
export default function rotateString(str: string): string[] {
  const result: string[] = [];
...
// Obervações: adorei essa challenge, me fez exercitar alguns conceitos basicos que estavam enferrujados.
